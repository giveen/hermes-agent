...
def show_status(args):
    ...
    if terminal_env == "ssh":
        ...
        docker_image = os.getenv("TERMINAL_DOCKER_IMAGE", "python:3.12-slim")
        print(f"  Docker Image: {docker_image}")
    elif terminal_env == "daytona":
        daytona_image = os.getenv("TERMINAL_DAYTONA_IMAGE", "nikolaik/python-nodejs:python3.12-nodejs20")
