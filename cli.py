...
from hermes_cli.cli_display_mixin import CLIDisplayMixin
...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIDisplayMixin, CLIBillingMixin, CLIVoiceMixin):
    """
