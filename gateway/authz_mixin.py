...
class GatewayAuthorizationMixin:
    ...
    def _adapter_enforces_own_access_policy(
        ...
        *,
        ...
        such as WeCom, Weixin, Yuanbao, and QQBot evaluate their
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        # Home Assistant runs its own authz at the connection level — the
        # agent can only connect after the HA operator authenticates their
        # WebSocket connection, so HA events are always authorized.
        ...
        platform_group_user_env_map: dict = {}  # legacy telegram only, removed
